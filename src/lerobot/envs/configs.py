...
class LiberoEnv(EnvConfig):
    ...
    task_ids: list[int] | None = None  # specific task IDs to evaluate (e.g., [0] for task 0 only)
    fps: int = 30
...
class ManiSkillEnv(EnvConfig):
    ...
    perturbation_set: str = "NONE"  # Perturbation set name: NONE, ALL, MO_COLOR, MO_TEXTURE, MO_SIZE, MO_MASS,
